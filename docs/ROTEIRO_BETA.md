...
5. Abra Config: VEÍCULO (consumo), CUSTOS (R$/L + combustível atual), CALIBRAR (−/+ das faixas), Sistema (título **Sistema**, depois **ENVIAR LOG** se a oferta não ler). Localização é opcional.
